...
,
  {
    icon: "/instagram.png",
    url: "https://www.instagram.com/ragul___27/"
  },
  {
    icon: "/github.png",
    url: "https://github.com/Ragulkan"
  },
  {
    icon: "/linkedin.png",
    url: "https://www.linkedin.com/in/ragul--kannan/"
  }
];
  ...
  return (
    <div className="min-h-screen flex flex-col items-start bg-[rgb(65,46,34)] py-2 px-4 sm:px-8 space-y-2">
      {/* Header */}
      <div className="bg-[rgb(27,27,27)] text-white px-3 py-2 rounded-2xl shadow-lg font-serif w-full">
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            {/* Left card */}
            <div className="relative bg-[rgb(27,27,27)] text-white rounded-lg shadow-lg font-serif flex flex-col justify-between
                            w-full md:w-[450px] p-4">
              {/* Top-right image */}
              ...
              <div className="flex justify-center mt-2">
                <div className="grid grid-cols-3 sm:grid-cols-3 gap-1 sm:gap-2 justify-items-center w-full max-w-[320px] 
                                bg-[rgb(71,60,51)] rounded-lg p-2">
                  {images.map((src, index) => (
                    <img key={index} src={src} alt={`icon-${index}`} className="w-8 sm:w-10 h-12 sm:h-16 object-contain" />
                  ))}
                </div>
              </div>
            ...
            <div className="w-full md:w-[400px] h-auto">
              <img src="coat.png" alt="coatphoto" className="w-full h-full object-cover rounded-lg shadow-lg" />
            </div>
          </div>

          {/* Bottom sections (sec1 & sec2) */}
          <div className="flex flex-col md:flex-row gap-4">
  ...
  "Code is not just about solving problems — it’s about creating solutions that matter."
        ...
        {/* RIGHT COLUMN */}
        <div className="flex flex-col flex-1 gap-4">
          <div className="bg-[rgb(27,27,27)] text-white px-4 py-4 rounded-lg shadow-lg flex flex-col items-start">
            {/* Slide image */}
            <div className="w-full flex justify-center">
              <img src={slides[currentIndex].src} alt={`slide-${currentIndex}`} className="w-full max-w-3xl h-auto object-contain rounded-lg" />
            </div>

            {/* Slide content */}
            <p className="mt-4 text-left text-white/80 w-full max-w-3xl text-base sm:text-lg leading-relaxed">
  ...
  <img
    src="/arrow-left.png"
    alt="previous"
    className="w-10 h-10 p-2 rounded-full cursor-pointer bg-gray-800 hover:bg-gray-700 
